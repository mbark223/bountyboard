// Public endpoint - brief by ID (returns full brief with organization and submission count)
import { Pool } from 'pg';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Get brief with organization info
    const query = `
      SELECT
        b.*,
    ...
    console.log('[API] Brief found:', { id: brief.id, title: brief.title, submissions: submissionCount });
